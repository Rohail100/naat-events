...
export default function EditEventPage({ evt,token }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!res.ok) {
      ...
      if(evtRes.error.name==="ValidationError"){
        toast.error('Name must be Unique, Try Different Name')
      }
      else{
  ...
  const imageUploaded = async (e) => {
    ...
    setImagePreview(ev.data.attributes.image.data.attributes.formats.thumbnail.url)
    setShowModal(false)
  }

  return (
    <Layout title='Edit The Event'>
